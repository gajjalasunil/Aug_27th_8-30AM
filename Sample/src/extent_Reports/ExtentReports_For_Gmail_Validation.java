...
public class ExtentReports_For_Gmail_Validation {
	...
	public static void main(String[] args) throws Exception {
		...
		String filepath="D:\\sunill\\27th_Aug_8-30AM\\Reports\\Gmail_validation.html";
		...
		test.log(LogStatus.INFO, "Homepage launch successfull");
		...
		String path="D:\\sunill\\27th_Aug_8-30AM\\login_email_valid.png";
		...
		{
			test.log(LogStatus.PASS, "As expected Password visible on valid email entry");
			test.log(LogStatus.INFO, "Screen captured "+test.addScreenCapture(path));
		}
		else
		{
			test.log(LogStatus.FAIL, "password not visible on valid email entry");
			test.log(LogStatus.INFO, "Screen captured "+test.addScreenCapture(path));
		}
